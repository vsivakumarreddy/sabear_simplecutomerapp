pipeline {
    ...
    environment {
        ...
        NEXUS_URL = "54.227.22.45:8081" // CORRECTED: Removed the leading "http://" from here
        ...
        SONARQUBE_URL = "http://52.23.206.60:9000/" // Keep the full URL here
        ...
        TOMCAT_URL = "http://54.227.22.45:8080/manager/html" // URL to your Tomcat Manager App
